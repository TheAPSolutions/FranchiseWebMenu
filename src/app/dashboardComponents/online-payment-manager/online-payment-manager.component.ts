...
@Component({
  selector: 'app-online-payment-manager',
  templateUrl: './online-payment-manager.component.html',
  styleUrl: './online-payment-manager.component.scss',
})
export class OnlinePaymentManagerComponent {
  ...
  onlinePaymentManager: WritableSignal<string> = signal('');
  ...
  updateTitles() {
    this.onlinePaymentManager = this.languageService.onlinePaymentManager;
  ...
  fetchOrders(): void {
    this.dashboardService
      .getFilteredOrdersCard(this.selectedBranch, this.startDate, this.endDate)
      .subscribe((data) => {
        this.orders = data;
