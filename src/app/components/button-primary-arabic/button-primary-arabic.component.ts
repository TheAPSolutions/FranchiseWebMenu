...
@Component({
  selector: 'app-button-primary-arabic',
  templateUrl: './button-primary-arabic.component.html',
  styleUrl: './button-primary-arabic.component.scss'
})
export class ButtonPrimaryArabicComponent {
