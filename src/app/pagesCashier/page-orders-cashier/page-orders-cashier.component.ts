...
@Component({
  selector: 'app-page-orders-cashier',
  templateUrl: './page-orders-cashier.component.html',
  styleUrl: './page-orders-cashier.component.scss',
})
export class PageOrdersCashierComponent {
  NewOrderPageTitle: WritableSignal<string> = signal('');
  ...
  private updateTitles() {
    ...
    this.NewOrderPageTitle = this.languageService.NewOrderPageTitle;
  ...
  private playNotificationSound() {
    // Ensure audio can play even when the tab is inactive
    const audio = new Audio('sounds/notificationSound.mp3');
    audio.load(); // Preload the audio

    // Play the audio, catching potential browser restrictions
    audio
      .play()
      .then(() => {
