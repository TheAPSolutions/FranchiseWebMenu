...
@Component({
  selector: 'app-saudibranches-website',
  templateUrl: './saudibranches-website.component.html',
  styleUrl: './saudibranches-website.component.scss',
  animations: [
...
export class SaudibranchesWebsiteComponent {
