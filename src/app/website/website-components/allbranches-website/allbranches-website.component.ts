...
@Component({
  selector: 'app-allbranches-website',
  templateUrl: './allbranches-website.component.html',
  styleUrl: './allbranches-website.component.scss',
  animations: [
...
export class AllbranchesWebsiteComponent {
