...
@Component({
  selector: 'app-iraqbranches-website',
  templateUrl: './iraqbranches-website.component.html',
  styleUrl: './iraqbranches-website.component.scss',
  animations: [
...
export class IraqbranchesWebsiteComponent {
