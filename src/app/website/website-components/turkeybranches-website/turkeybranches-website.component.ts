...
@Component({
  selector: 'app-turkeybranches-website',
  templateUrl: './turkeybranches-website.component.html',
  styleUrl: './turkeybranches-website.component.scss',
  animations: [
...
export class TurkeybranchesWebsiteComponent {
  ...
  onCall(number: string) {
    ...
    window.open(`tel:${number}`); // Open dialer with phone number
  }
